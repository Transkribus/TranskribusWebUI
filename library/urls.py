...
urlpatterns = [
    ...
    url(r'^changed_jobs_modal$', views.changed_jobs_modal,
        name='changed_jobs_modal'),
    ...
    url(r'^create_collection_modal$', views.create_collection_modal,
        name='create_collection_modal'),
    url(r'^collections_dropdown$', views.collections_dropdown,
        name='collections_dropdown'),
    ...
    url(r'^collection_noaccess/([0-9]+)$',
        views.collection_noaccess, name='collection_noaccess'),
    url(r'^document/([0-9]+)/([0-9]+)$', views.document, name='document'),
    url(r'^page/([0-9]+)/([0-9]+)/([0-9]+)$', views.page, name='page'),
    url(r'^transcript/([0-9]+)/([0-9]+)/([0-9]+)/([0-9]+)$',
        views.transcript, name='transcript'),
    url(r'^region/([0-9]+)/([0-9]+)/([0-9]+)/([0-9]+)/([\w-]+)$',
        views.region, name='region'),  # TODO improve regionId regex?
    # TODO as above...
    url(r'^line/([0-9]+)/([0-9]+)/([0-9]+)/([0-9]+)/([\w-]+)/([\w-]+)$',
        views.line, name='line'),
    # oh no he di'nt
    # TODO as above...
    url(r'^word/([0-9]+)/([0-9]+)/([0-9]+)/([0-9]+)/([\w-]+)/([\w-]+)/([\w-]+)$',
        views.word, name='word'),
    # oh yes he di'
    url(r'^rand/([0-9]+)/(word|line|region|transcript|document)$',
        views.rand, name='rand'),
